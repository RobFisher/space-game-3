# Ship Flight Plans Specification

## Purpose

Define player ship flight plans, including creation, target interception, transfer motion, replacement, cancellation, and status behavior.
